...
class Solution:
    def findClosestElements(self, arr: List[int], k: int, x: int) -> List[int]:
        ...
        # еше проще - исходное фейковое окно [l; l-1] - оно пустое
        # НО - далее либо будет r += 1 и тогда получаем уже норм окно [l; l]
        # либо будет l -= 1 и тогда получаем тоже норм окно [l-1; l-1]
        # где l - это индекс, найденный выше бин поиском
        l, r = l - 1, l
        while r - l - 1 < k:
            if l < 0:
                r += 1
